...
var allowedRepeatedEventsRegex = combinedRegexp(allowedRepeatedEventPatterns...)

func CombinedAllowedRepeatedEventsRegex() *regexp.Regexp {
	return allowedRepeatedEventsRegex
}
